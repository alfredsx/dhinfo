...
$modversion['blocks'][1]['name'] 			  = constant('_MI_'.$langname.'_BLOCK1');
$modversion['blocks'][1]['description'] = constant('_MI_'.$langname.'_BLOCK1_DESC');
...
$modversion['config'][5]['options'] 		= array('_MI_'.$langname.'_NONE'    => 0,
