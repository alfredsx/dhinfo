...
define('_INFO_URL_INTLINK','Link unter '.XOOPS_URL.'/');
define('_INFO_URL_EXTLINK','externen Link öffnen');
define('_INFO_URL_INTDATEI','lokale Datei einbinden');

define('_INFO_LISTBLOCKCAT','Kategorie bearbeiten');
define('_INFO_ADDBLOCKCAT','Kategorie hinzufügen');
define('_INFO_EDITBLOCKCAT','Kategorie bearbeiten');
define('_INFO_ERROR_NOBLOCKTITLE','Kein Kategorietitel angegeben!');
...
// Added in V 2.3
define('_INFO_URL_PHP','PHP-Code Seite');
