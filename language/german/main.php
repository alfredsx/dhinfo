...
if (!defined('_INFO_FILENOTFOUND')) {
  define('_INFO_FILENOTFOUND','die gewählte Seite ist nicht vorhanden!');
  define("_INFO_PRINTERFRIENDLY","Druckerfreundliche Seite generieren");
  ...
  define('_INFO_SECURITY_CODE','Sicherheitscode');
  define("_INFO_SECURITY_GETCODE","Sicherheitscode eingeben");
